...
[![Travis Build Status](https://travis-ci.org/justcompile/go-dockerclient.svg?branch=master)](https://travis-ci.org/justcompile/go-dockerclient)
[![AppVeyor Build Status](https://ci.appveyor.com/api/projects/status/4m374pti06ubg2l7?svg=true)](https://ci.appveyor.com/project/justcompile/go-dockerclient)
[![GoDoc](https://img.shields.io/badge/api-Godoc-blue.svg?style=flat-square)](https://godoc.org/github.com/justcompile/go-dockerclient)
...
import (
	...
	"github.com/justcompile/go-dockerclient"
)
...
```
% git clone -b docker-1.9/go-1.4 https://github.com/justcompile/go-dockerclient.git $GOPATH/src/github.com/justcompile/go-dockerclient
% git clone -b v1.9.1 https://github.com/docker/docker.git $GOPATH/src/github.com/docker/docker
% go get github.com/justcompile/go-dockerclient
```
